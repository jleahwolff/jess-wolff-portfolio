...
function Navigation(){
    return(
        <div className={'py-10 px-10 grid grid-cols-6 gap-4'}>
            <div className={'col-start-1 col-end-4 font-poppins text-white dark:text-purple-400'}>
            ...
            <div className={'col-end-7 col-span-2 font-poppins text-white dark:text-purple-500'}>
                <Link to={'/'}>
